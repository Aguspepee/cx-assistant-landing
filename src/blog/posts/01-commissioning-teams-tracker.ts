...
const post: BlogPostMeta = {
  ...
  content: [
    {
      type: 'paragraph',
      text: 'In many commissioning projects today, documentation tracking is still handled using large Excel spreadsheets.',
    },
    {
      type: 'paragraph',
      text: 'If you have worked on data center or industrial commissioning projects, you have probably seen trackers like this:',
    },
    {
      type: 'screenshot',
    ...
    {
      type: 'paragraph',
      text: 'In theory, this works. In practice, it creates several problems that teams deal with on almost every project.',
    },
    {
      type: 'h2',
      text: 'The Problems with Traditional Excel Documentation Trackers',
    },
    {
      type: 'paragraph',
      text: 'Across multiple projects and countries, we repeatedly encountered the same issues.',
    },
    {
      type: 'h3',
      text: '1. Documents are often not linked',
    },
    {
      type: 'paragraph',
      text: 'In many trackers, the spreadsheet only shows status. But the actual document lives somewhere else:',
    },
    {
      type: 'bullet-list',
      items: [
        'SharePoint or BIM360',
        'Datascope or similar platforms',
        'Email threads',
        'Local folders and vendor portals',
      ],
    },
    {
      type: 'paragraph',
      text: 'The tracker tells you the document exists, but not where it is. You still need to search for it.',
    },
    {
      type: 'h3',
      text: '2. Links are added manually',
    },
    {
      type: 'paragraph',
      text: 'In the best cases, teams paste links manually into Excel. This creates new problems: links break, permissions change, documents move, versions change. Very often the link points to an outdated file or stops working completely.',
    },
    {
      type: 'h3',
      text: '3. Documentation is not tied to assets',
    },
    {
      type: 'paragraph',
      text: 'Some commissioning platforms store documentation, but not connected to a specific asset. So documents exist in the system, but you cannot easily answer questions like:',
    },
    {
      type: 'bullet-list',
      items: [
        'Do we have the FAT for this UPS?',
        'Where is the IR test for this panel?',
        'Which CRAC units are missing the O&M manual?',
      ],
    },
    {
      type: 'paragraph',
      text: 'Without a strong asset link, documentation quickly becomes difficult to track.',
    },
    {
      type: 'h3',
      text: '4. Documentation expectations are unclear',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'h3',
      text: '5. To see documentation, you must open each asset',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'h2',
      text: 'Designing a Better Documentation Tracker',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'The idea is simple: each row represents an asset, each column represents an expected document. But instead of empty cells, we use documentation placeholders.',
    },
    {
      type: 'h3',
      text: 'Documentation Placeholders',
    },
    {
      type: 'paragraph',
      text: 'Placeholders define what documentation is expected for each asset. For example:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'These placeholders can be configured per project. Engineers no longer need to guess what documentation is required — the system defines it.',
    },
    {
      type: 'screenshot',
    ...
    {
      type: 'h3',
      text: 'Linking Documents Becomes Simple',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'h3',
      text: 'Direct Access to Documents',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'h2',
      text: 'Making Documentation Accessible with AI',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'h2',
      text: 'A Small Change with a Big Impact',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'h2',
      text: 'Built by Engineers Who Use These Systems',
    },
    {
      type: 'paragraph',
